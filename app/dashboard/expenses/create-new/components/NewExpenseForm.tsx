...
const NewExpenseForm: React.FC<CustomerAccountProps> = ({ currentUser }) => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    toast("Creating expense, please wait...");
    ...
    axios
      .post("/api/create-expense", expenseData)
      .then(() => {
        ...
        <div className="p-7">
          <form action="#">
            ...
            <div className="mb-5.5 flex flex-col sm:items-center gap-5.5 sm:flex-row">
              ...
              <div className="w-full sm:w-1/2">
                ...
                <input
                  ...
                  id="vendor"
                  disabled={isLoading}
                  {...register("vendor", { required: false })}
                  type="text"
                  name="vendor"
                  required
                  placeholder="Expense Name"
              ...
              <div className="w-full sm:w-1/2">
                ...
                <div className="relative z-20 bg-white dark:bg-form-input">
                  ...
                  >
                    ...
                    <option value=" Website Development & Maintenace">
            ...
            <div className="flex justify-end gap-4.5">
              ...
              >
                {isLoading ? "Loading..." : "Record Expense"}
              </button>
            </div>
          </form>
        </div>
